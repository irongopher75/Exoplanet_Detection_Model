...
def load_urls_from_metadata(metadata_dir: Path, sectors: Optional[List[int]] = None) -> List[Dict[str, Any]]:
    ...
    # Only look for ones generated by extract_all_data or similar, or just scan all json
    # The curl scripts generated JSONs named tesscurl_sector_X_metadata.json in previous steps
    metadata_files = list(metadata_dir.glob("tesscurl_sector_*_metadata.json"))
    
    if not metadata_files:
        # Fallback: look for ANY json that might contain URLs
